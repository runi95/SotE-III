...
declare let skill: number;
declare let skills1: number;
declare let skills2: number;
declare let skills3: number;
declare let max_hero_level: number;
declare let harass_qty: number;
declare let harass_max: number;
declare let harass_units: number;
declare let harass_length: number;
declare let defense_qty: number;
declare let defense_units: number;
declare let defense_length: number;
declare let build_qty: number;
declare let build_type: number;
declare let build_item: number;
declare let build_town: number;
