...
const name = 'Medallion of Courage';
const labels: ItemLabel[] = [ItemLabel.STRENGTH, ItemLabel.BLOCK];
const goldCost = 9350;
const iconPath = 'ReplaceableTextures\\CommandButtons\\BTNMedalionOfCourage.blp';
const description = `A proof of courage amongst heroes.
