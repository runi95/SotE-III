...
export class GameGlobals {
    ...
    public HelmOfValorCount: number[] = [];
    ...
    public PlayerSpawnRegion: rect[] = [
        Rect(9088.0, 9088.0, 11392.0, 11392.0),
        Rect(9088.0, -1408.0, 11392.0, 896.0),
        Rect(9088.0, -11904.0, 11392.0, -9600.0),
        Rect(-5504.0, 9088.0, -3200.0, 11392.0),
        Rect(-5504.0, -1408.0, -3200.0, 896.0),
        Rect(-5504.0, -11904.0, -3200.0, -9600.0),
    ];

    public PlayerExitPoint: Point[] = [
        new Point(8576, 10240),
        new Point(8576, -256),
        new Point(8576, -10720),
        new Point(-2656, 10240),
        new Point(-2656, -256),
        new Point(-2656, -10720),
    ];
